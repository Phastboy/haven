...
export interface IOfferService {
  getOfferPriceAndOwnerAndStatus(offerId: string): Promise<{ price: number; ownerId: string; status: string } | null>;
}
...
export class CreateOrderUseCase {
  ...
  async execute(params: { offerId: string; requesterId: string; quantity: number; message?: string }): Promise<Order> {
