...
describe('TokenService', () => {
  it('should throw an error if TOKEN_SECRET is missing', () => {
    ...
    expect(() => new TokenService()).toThrow('CRITICAL: TOKEN_SECRET environment variable is not set');
  ...
  it('should consistently hash the token', () => {
    ...
    const token = '12158192c818405d553d888d2d629d998ef9c213c75841681ed767b9783b21dc4fc0274684eb8e85ff66cceabbe7876a2cb4a17f8241987a0e2280aa0b5ae563';
